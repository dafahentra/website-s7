  ...
  return (
    <div className="max-w-[1200px] mx-auto my-40">
      ...
      <div className="flex justify-center">
        <button className="mt-4 bg-[#1d3866] px-8 py-4 rounded-full w-[200px] text-white hover:border-[#1d3866] hover:bg-white hover:text-[#1d3866] transition-colors duration-300 text-md shadow-2xl shadow-[#1d3866] border-2 border-[#1d3866]">
          Selengkapnya
        </button>
      </div>
    </div>
