// pages/About/StorySection.jsx - REFACTORED WITH DESIGN SYSTEM
...
const StorySection = () => {
  return (
    <div className="max-w-[1200px] mx-auto mb-element-sm md:mb-element-md lg:mb-element">
      <div className="grid lg:grid-cols-2 gap-16 items-center mx-4">
        ...
        >
          ...
          <p className={`${TYPOGRAPHY.body.default} text-gray-700 leading-relaxed mb-6`}>
