// pages/About/BoardOfDirectors.jsx - REFACTORED WITH DESIGN SYSTEM
...
const MemberCard = ({ member, delay, isMobile = false }) => {
  ...
  // Mobile: 40% smaller than desktop (240px -> 144px)
  ...
  const nameSize = isMobile ? TYPOGRAPHY.body.small : TYPOGRAPHY.subheading.lg;
  const positionSize = isMobile ? 'text-xs' : TYPOGRAPHY.body.regular;
