// pages/Store.jsx - REFACTORED WITH DESIGN SYSTEM
  ...
  return (
    <>
      ...
      <div className="pt-32 min-h-screen bg-white">
        ...
        <div className="w-full mb-element-md md:mb-element">
          <motion.div
        ...
        <div className="text-center mb-12 px-4">
          <Heading as="h1" variant="page" color="navy" center>
            Our Store
          </Heading>
        </div>

        {/* Store List Section */}
        <div className="max-w-[1300px] mx-auto px-4 pb-element-md md:pb-element">
          <div className="grid md:grid-cols-2 gap-6">
            {stores.map((store, index) => (
              <motion.div
                ...
                className={`bg-white ${RADIUS.card.responsive} border border-gray-200 overflow-hidden ${SHADOWS.card.responsive} ${TRANSITIONS.fast} cursor-pointer group`}
              >
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between">
                    <div>
                      <h3 className={`${TYPOGRAPHY.subheading.tablet} ${TYPOGRAPHY.weight.bold} text-gray-900 mb-4`}>
                        {store.name}
                      </h3>
                      ...
                      <div className="flex items-start gap-2 mb-3">
                        ...
                        <p className={`text-gray-600 leading-relaxed ${TYPOGRAPHY.body.small}`}>
                          {store.address}
                        </p>
                      </div>
                      ...
                      <a
                        ...
                        className={`text-brand-green hover:underline ${TYPOGRAPHY.body.small} ${TYPOGRAPHY.weight.medium} mb-4 inline-block`}
                      ...
                      <div className="flex items-center gap-2">
                        <div className={`w-2 h-2 bg-brand-green ${RADIUS.circle}`}></div>
                        <p className={`text-gray-900 ${TYPOGRAPHY.weight.medium} ${TYPOGRAPHY.body.small}`}>
                          {store.hours}
                        </p>
                      </div>
                    </div>
