...
export const newsData = [
{
    ...
    img: fore1,
    excerpt: "Fore Coffee memperingati Hari Kartini pada Sabtu, 20 April 2024 di HO Fore Coffee, Jakarta.",
    content: [
    {
        type: "text",
        value: "Fore Coffee memperingati Hari Kartini pada Sabtu, 20 April 2024 di HO Fore Coffee, Jakarta. Perayaan yang diperingati setiap tanggal 21 April setiap tahunnya ini adalah bentuk untuk menghargai perjuangan R.A Kartini, seorang tokoh inspiratif bagi kaum perempuan di Indonesia."
    },
    {
        type: "text",
        value: "Momen ini juga jadi cara mengapresiasi perjuangan Kartini dalam meraih kesetaraan di berbagai bidang. Berkembangnya zaman dan teknologi membuat perempuan harus dapat beradaptasi dengan baik mulai dari pendidikan, karir, hingga menjalani kehidupan sehari-hari."
    },
    {
        type: "image",
        src: fore1,
...
// Helper function untuk mendapatkan artikel berdasarkan id
